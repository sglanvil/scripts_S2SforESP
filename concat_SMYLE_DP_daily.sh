...
for imember in {011..030}; do
        ...
        # ------ OVERLAP ------
        ncks -O -d time,1,2981 ${file2} ${destDirNew}/tmp2_${ivar}_${iyear}_${imonth}.nc
        ncks -O -d time,1,730 ${file1} ${destDirNew}/tmp1_${ivar}_${iyear}_${imonth}.nc
        ncrcat -O ${destDirNew}/tmp1_${ivar}_${iyear}_${imonth}.nc ${destDirNew}/tmp2_${ivar}_${iyear}_${imonth}.nc ${outFile}
        rm ${destDirNew}/tmp1_${ivar}_${iyear}_${imonth}.nc
        rm ${destDirNew}/tmp2_${ivar}_${iyear}_${imonth}.nc

        timeLength=$(ncdump -h ${outFile} | grep UNLIMITED | grep -o '[0-9]*')
        if [ ${timeLength} != 3711 ]; then
